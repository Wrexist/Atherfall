...
export interface EnemyDef {
  ...
  tint?: string;
  boss?: boolean;
  /** One-time world encounter: never respawns, defeat is saved. */
  elite?: boolean;
  respawnDelay: number;
...
export const ENEMIES: Record<string, EnemyDef> = {
  ...
  rootfather: {
    ...
    recover: 0.9,
    xp: 140,
    lootTable: "rootfather",
    tint: "#5d7a38",
    elite: true,
    respawnDelay: 99999,
    zone: { kind: "cone", radius: 4.2, arc: 2.4 },
  },
  drowned: {
    id: "drowned",
    ...
    tint: "#4f8e8a",
    respawnDelay: 40,
    zone: { kind: "cone", radius: 3.0, arc: 1.9 },
  },
  tidebound: {
    id: "tidebound",
    ...
    elite: true,
    respawnDelay: 99999,
    zone: { kind: "circle", radius: 2.8, offset: 2.0 },
  },
};
